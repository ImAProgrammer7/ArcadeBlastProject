...
public class SurvivalLeaderboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survival_leaderboard);

        db = FirebaseFirestore.getInstance();
        firebaseStorage = FirebaseStorage.getInstance();
        storageReference = firebaseStorage.getReference();
        leaderboard = findViewById(R.id.survivalLeaderboardList);
        users = new ArrayList<>();

        Query q = db.collection("users").orderBy("survivalHighScore", Query.Direction.DESCENDING);
        q.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if (value != null) {
                    ...
                    userAdapter = new UserAdapter(SurvivalLeaderboard.this, 0, 0, users, "survival");
        ...
        leaderboard.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Dialog dialog = new Dialog(SurvivalLeaderboard.this);
